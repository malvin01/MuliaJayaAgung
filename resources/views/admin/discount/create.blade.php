                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" maxlength="3" class="form-control {{ $errors->has('discount_percent') ? ' is-invalid' : '' }}" name="discount_percent" value="{{ old('discount_percent') }}" aria-describedby="basic-addon2" required>
