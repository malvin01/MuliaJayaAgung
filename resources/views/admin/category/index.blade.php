                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex justify-content-between">
                                ...
                                <a href="{{ route('admin.categories.create') }}" class="btn icon icon-left btn-primary">Add Category</a>
                            </div>
                        </div>
                                    ...
                                    <table class="table table-lg" id="tbl_category">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                   ...
                                                   <td>
                                                    <div class="d-flex">
                                                        <a href="{{ route('admin.categories.edit', $category->id) }}" class="btn btn-primary me-1 mb-1">Edit</a>
